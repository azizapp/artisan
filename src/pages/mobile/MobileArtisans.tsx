    ...
    <div className="p-4 space-y-4 pb-20">
      ...
      <div className="space-y-3">
        {filteredArtisans.map((artisan) => (
          <div
            ...
            className="bg-card rounded-lg p-4 border border-border cursor-pointer hover:bg-muted/30 transition-colors active:bg-muted/50"
          >
            {/* Name + Trade (left) | Shop# + Area + Status (right) */}
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">{t('artisan.shopStatus')}</label>
            <select
